...
abstract class AppLocalizations {
  ...
  /// No description provided for @trackFolio.
  ///
  /// In en, this message translates to:
  /// **'Track Folio'**
  String get trackFolio;

  /// No description provided for @mainTitle.
  ///
  /// In en, this message translates to:
  /// **'Track your daily activities and habits with ease.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'New here? Create your studio space in seconds.'**
  String get newHere;
